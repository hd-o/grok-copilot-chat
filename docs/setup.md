...
| `grokCopilot.requestTimeoutSeconds` | `600` | Request timeout in seconds, including streamed body reads |
...
- **Chat stuck on Working… / Reasoning…:** stalled streams should time out instead of hanging until a window reload; check the Grok output channel for the timeout error.
